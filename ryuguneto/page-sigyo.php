      ...
      <section class="select_purch">
        <div class="container-in">
          <div class="l_item_flex_ttl">
            <img src="<?php echo get_template_directory_uri(); ?>/img/chara.webp" alt="ロゴ" />
            <h2>選べる鑑定方法<br class="is-sp"><span class="is-sp">SELECT PURCHASE</span></h2><span class="is-pc">SELECT PURCHASE</span>
          </div>
          <div class="t_feature_item1_method_wrap t_feature_item1_method_wrap-kantei">
            <!-- 出張買取 -->
            ...
            <div class="t_feature_item1_method_right">
              <h5 class="t_feature_item1_method_sub_ttl">店頭鑑定</h5>
              <p class="t_feature_item1_method_sub_txt t_feature_item_txt t_feature_item_txt-kantei">
                店頭へ持ち込みにて査定
              </p>
              <div class="t_feature_item1_method_info t_feature_item1_method_info-kantei">
