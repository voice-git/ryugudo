...
<footer class="footer">
          ...
          <div class="footer_left">
            ...
            <div class="footer_info">
              <p class="footer_info_code">
                〒920-0052 石川県金沢市薬師堂町イ52<br class="is-sp">
                <span>Tel.076-255-0065</span>
              </p>
    ...
    <div class="bottom_fixed">
      <a href="<?php echo $contact; ?>" class="bottom_fixed_wrapper">
        ...
        <img src="<?php echo get_template_directory_uri(); ?>/img/bottom-fixed-tel-sp.webp" alt="" class="is-sp">
      </a>
    </div>
  </body>
</html>
