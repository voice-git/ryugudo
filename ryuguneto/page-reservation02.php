          ...
          <div class="reserved-step1">
            <div class="form_top">
              <p>
                ...
                返信がない場合はお電話にてお問合せお願いします。<br class="is-pc"/>当日お急ぎのお客様や品数が多い場合や相談ごとがある場合は<br class="is-pc"/>お電話にてお問合せお願いします。<br><span class="warning-label_text">※来店のご予約は必須ではありません。営業日並びに営業時間内でしたらご都合良い時間帯にてご来店ください。</span>
              </p>
            ...
            <?php echo do_shortcode('[contact-form-7 id="b727bd7" title="来店予約"]'); ?>
          </div>
        </div>
      </section>
    </main>
