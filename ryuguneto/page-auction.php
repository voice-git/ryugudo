...
<?php get_header(); ?>
                ...
                <ul>
                  <li>
                    ...
                    <div class="l_acn_toc_col1_right">
                      <p>
                        落札手数料<br class="is-sp"><span class="price-big din">22</span
                        >%<span class="price-mid">（税別）</span>
                  ...
                  <li>
                    ...
                    <div class="l_acn_toc_col1_right">
                      <p>
                        落札手数料<br class="is-sp"><span class="price-big din">20</span>%<span
                          class="price-mid"
                          >（税別）</span
                        >
                      </p>
                  ...
                  <li>
                    ...
                    <div class="l_acn_toc_col1_right">
                      <p>
                        落札手数料<br class="is-sp"><span class="price-big din">15</span
                        >%<span class="price-mid">（税別）</span>
                      </p>
                    </div>
                  </li>
