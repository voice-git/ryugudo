<?php 
    ...
    $ihinseiri = esc_html(home_url('/ihinseiri/'));
      ...
      <section class="t_banner">
        <div class="container">
          <ul class="t_banner_wrap">
            ...
            <li>
              <a href="<?php echo $ihinseiri; ?>">
                <img src="<?php echo get_template_directory_uri(); ?>/img/banner-ihin.webp" alt="遺品買取" class="is-pc" />
                <img src="<?php echo get_template_directory_uri(); ?>/img/banner-ihin-sp.webp" alt="遺品買取" class="is-sp" />
              </a>
            </li>
            <li>
          ...
          <div class="access_wrapper">
            ...
            <div class="access_caution">
              ...
              <p class="access_caution_txt">
                ...
                ※店頭での買取受付は<span class="din">9:00-17:00</span>となっております。 日曜・祝日は<span class="din">16:00</span>迄です。<br />
                ※臨時休業の場合や査定士が出張買取で不在の場合もあります。事前にお電話いただければ幸いです。
              </p>
            </div>
