                ...
                <ul class="l_item_list">
                  ...
                  <li>
                    ...
                    <div class="l_item_list_right">
                      ...
                      <p class="l_item_list_txt">
                        ギヤマンは、元来ダイヤモンドを指す言葉であり、オランダ語のディアマンテに由来すると言われています。江戸時代から明治時代にかけて、ガラス製品全般をギヤマンと呼ぶようになりました。ギヤマンは素材に鉛を使用しているため、重厚感がありますが、破損しやすいという特徴があります。菓子器や茶托としてもご活用いただけます。こちらは、江戸時代後期のギヤマン製品です。
                      </p>
                    </div>
                  </li>
                  <li>
                    ...
                    <div class="l_item_list_right">
                      ...
                      <p class="l_item_list_txt">
時代物の明治時代～昭和40年代にかけてのブリキのおもちゃやソフトビニール人形など取扱いしております。<br>
ジャンボマシンダーなど特に人気の高いお品など、もはや子供の玩具の域を超えて大人の鑑賞用としても国内外人気があります。
                      </p>
                    </div>
                  </li>
                  <li>
