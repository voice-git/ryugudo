...
<!-- End Google Tag Manager -->
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-D77SL73CRL"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());
    
      gtag('config', 'G-D77SL73CRL');
    </script>
    <meta charset="UTF-8" />
        ...
        <nav class="nav">
          <ul class="nav-list">
            ...
            <li class="has-child">
              ...
              <div class="megaMenu">
                <ul>
                  <li><a href="<?php echo $kutani; ?>">九谷焼・輪島塗</a></li>
      ...
      <div class="drawer-menu_wrapper">
        ...
        <div class="drawer-menu_right">
          <ul class="drawer-nav-list">
            <li><a href="<?php echo $newcustomer; ?>">初めての方へ</a></li>
            <li><a href="<?php echo $ihinseiri; ?>">遺品買取・整理</a></li>
            <li><a href="<?php echo $buylist; ?>">買取実績</a></li>
            <li><a href="<?php echo $recruit; ?>">リクルート</a></li>
            <li><a href="<?php echo $kaitori; ?>">出張買取・店頭買取</a></li>
